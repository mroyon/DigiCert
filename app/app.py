...
async def app_init():
    ...
    db_client = AsyncIOMotorClient(settings.MONGO_CONNECTION_STRING).DigiCertRequest
...
async def read_root():
    ...
    return {
        ...
        "Software Architect": "Mahmudur Rahman",
        "Github": "https://github.com/mroyon/DigiCert"
    }
