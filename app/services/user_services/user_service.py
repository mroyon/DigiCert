...
class UserService:
    ...
    async def authenticate(email: str, password: str) -> Optional[UserModel]:
        ...
        :return:
        """
        print("authenticate(email) level 1 ")

        user = await UserService.get_user_by_email(email)


        print("authenticate(email) level 2 ")
    ...
    async def create_user(user: UserAuth):
        ...
        :return:
        """
        print('I am OKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKK')
        user_in = UserModel(
    ...
    async def get_user_by_email(email: str) -> UserModel:
        ...
        print('Connected to MongoDBAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA...')
